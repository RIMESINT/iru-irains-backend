...
// ─────────────────────────────────────────────────────────────────────────────
// 1. DAILY
//    POST /api/v1/karnataka-aws/daily
...
exports.fetchDailyData = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: "Karnataka Daily data fetched", data: result.rows });

    } catch (error) {
        console.error("[KA AWS] fetchDailyData:", error);
...
// ─────────────────────────────────────────────────────────────────────────────
// 2. HOURLY
//    POST /api/v1/karnataka-aws/hourly
...
exports.fetchHourlyData = async (req, res) => {
    try {
        ...
        const result = await client.query(query, params);
        res.status(200).json({ success: true, message: "Karnataka Hourly data fetched", data: result.rows });

    } catch (error) {
        console.error("[KA AWS] fetchHourlyData:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};
...
// ─────────────────────────────────────────────────────────────────────────────
// 3. SLOT
//    POST /api/v1/karnataka-aws/slot
...
exports.fetchSlotData = async (req, res) => {
    try {
        ...
        const result = await client.query(query, params);
        res.status(200).json({ success: true, message: "Karnataka Slot data fetched", data: result.rows });

    } catch (error) {
        console.error("[KA AWS] fetchSlotData:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};
...
// ─────────────────────────────────────────────────────────────────────────────
// 4. CUMULATIVE
//    POST /api/v1/karnataka-aws/cumulative
//    Body: { startDate?, endDate?, district? }
// ─────────────────────────────────────────────────────────────────────────────
exports.fetchCumulativeData = async (req, res) => {
    try {
        ...
        const result = await client.query(query, params);
        res.status(200).json({ success: true, message: "Karnataka Cumulative data fetched", data: result.rows });

    } catch (error) {
        console.error("[KA AWS] fetchCumulativeData:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};
...
// ─────────────────────────────────────────────────────────────────────────────
// 5. DISTRICT SUMMARY
//    POST /api/v1/karnataka-aws/district-summary
//    Body: { date? }
// ─────────────────────────────────────────────────────────────────────────────
exports.fetchDistrictSummary = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: "Karnataka District summary fetched", data: result.rows });

    } catch (error) {
        console.error("[KA AWS] fetchDistrictSummary:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};
...
// ─────────────────────────────────────────────────────────────────────────────
// 6. ACTUAL DEPARTURE
//    POST /api/v1/karnataka-aws/actual-departure
...
exports.fetchActualDeparture = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: "Karnataka AWS actual departure fetched", data });
    } catch (error) {
        console.error("[KA AWS] fetchActualDeparture:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};
...
//    POST /api/v1/karnataka-aws/departure-analysis
//    Body: { startDate?, endDate? }
// ─────────────────────────────────────────────────────────────────────────────
exports.fetchDepartureAnalysis = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            message: "Karnataka AWS departure analysis fetched",
            data: {
                categoryCounts,
        ...
        console.error("[KA AWS] fetchDepartureAnalysis:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};
...
//    POST /api/v1/karnataka-aws/departure-export
...
exports.fetchDepartureForAPIexport = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: "Karnataka AWS departure data fetched", data });
    } catch (error) {
        console.error("[KA AWS] fetchDepartureForAPIexport:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};
