...
exports.fetchDailyData = async (req, res) => {
    try {
        ...
        const query = `
            ...
            GROUP BY aws_day, district, id, station, lat, lon
...
// POST /api/v1/iitm-mumbai/actual-departure
exports.fetchActualDeparture = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: "IITM Mumbai actual departure fetched", data });
    } catch (error) {
        console.error("[IITM MUM] fetchActualDeparture:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};

// POST /api/v1/iitm-mumbai/departure-analysis
exports.fetchDepartureAnalysis = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true, message: "IITM Mumbai departure analysis fetched",
            data: {
                categoryCounts,
        ...
        console.error("[IITM MUM] fetchDepartureAnalysis:", error);
        res.status(500).json({ success: false, message: error.message });
    }
};

// POST /api/v1/iitm-mumbai/departure-export
