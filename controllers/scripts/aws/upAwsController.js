...
// 1. FULL DAY â sum all 15-min slots per station (AWS day)
...
// âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
// 2. HOURLY â sum per station per IST hour within AWS day
...
exports.fetchHourlyData = async (req, res) => {
    try {
        ...
        const query = `
            ...
            GROUP BY aws_day, EXTRACT(HOUR FROM ist_time)::INT, district, id, station, type
...
// âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
// 3. SINGLE 15-MIN SLOT â exact IST time reading per station
...
// âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
// 4. CUMULATIVE RUNNING TOTAL â day-by-day running sum per station (AWS days)
...
// âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
// 5. DISTRICT SUMMARY â aggregated at district level (AWS day)
...
//    POST /api/v1/up-aws/station-slots
//    Body: { date? }
// âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
exports.fetchStationSlots = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            message: "UP AWS station slots fetched successfully",
            data: result.rows
        });

    } catch (error) {
        console.error("[UP AWS] fetchStationSlots error:", error);
...
exports.fetchDepartureForAPIexport = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            message: "UP AWS departure data fetched",
            fromDate,
            toDate,
            data
        });
