...
exports.insertStationDataFtp = async(req, res) => {
    try {
...
const createStationDailyDataTable = async () => {
      const createTableQuery = `
        CREATE TABLE IF NOT EXISTS public.station_daily_data_ftp
        (
            ...
            CONSTRAINT station_daily_data_ftp_pkey PRIMARY KEY (id)
        );
    `;
