...
const awsRealtimeRoutes = require("./routes/awsRealtimeRoutes");
...
const officerPassKeyRoutes = require("./routes/officerPassKeyRoutes");
...
app.use("/api/v1/", awsRealtimeRoutes);
...
app.use("/api/v1/", officerPassKeyRoutes);
